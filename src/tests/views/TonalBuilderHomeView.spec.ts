    ...
    expect(wrapper.getComponent(MaterialSurfacePreview).props('rolePalettes')).toEqual([
      {
        ...
        excludedTone: tonalScale.getRoleSurfaceAssignmentExcludedTone('surface'),
        tones: useTonalScaleStore().getRoleFullStrip('surface'),
        surfaceTones: useTonalScaleStore().surfaceExtendedStrip,
      },
      {
        role: 'primary',
        label: 'Primary',
        ...
        excludedTone: tonalScale.getRoleSurfaceAssignmentExcludedTone('primary'),
        tones: useTonalScaleStore().getRoleFullStrip('primary'),
        surfaceTones: useTonalScaleStore().primaryExtendedStrip,
      },
      {
        role: 'secondary',
        label: 'Secondary',
        ...
        excludedTone: tonalScale.getRoleSurfaceAssignmentExcludedTone('secondary'),
        tones: useTonalScaleStore().getRoleFullStrip('secondary'),
        surfaceTones: useTonalScaleStore().getRoleExtendedStrip('secondary'),
      },
      {
        role: 'tertiary',
        label: 'Tertiary',
        ...
        excludedTone: tonalScale.getRoleSurfaceAssignmentExcludedTone('tertiary'),
        tones: useTonalScaleStore().getRoleFullStrip('tertiary'),
        surfaceTones: useTonalScaleStore().getRoleExtendedStrip('tertiary'),
      },
      {
        role: 'error',
        label: 'Error',
        ...
        excludedTone: tonalScale.getRoleSurfaceAssignmentExcludedTone('error'),
        tones: useTonalScaleStore().getRoleFullStrip('error'),
        surfaceTones: useTonalScaleStore().getRoleExtendedStrip('error'),
      },
    ]);
  });

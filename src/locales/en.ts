export default {
  ...
  tonal_builder: {
    ...
    clipboard: {
      context_helper: 'Right-click a swatch or press Shift+F10 to open contextual copy actions.',
      shortcut_helper: 'Keyboard shortcut: Shift+F10 (or Context menu key).',
      copy_color: 'Copy hovered color',
      copy_aa_pair: 'Copy AA pair',
      copy_aaa_pair: 'Copy AAA pair',
      svg_helper: 'Exports visible strips plus URL + JSON metadata.',
      selection_helper: 'Latest hovered base and nearest pairs feed these actions.',
      copy_error: 'Unable to copy value. Check clipboard permissions.',
      missing_selection: 'Hover a swatch to enable copy actions.',
      unsupported: 'Clipboard is not available in this browser.',
      svg_copied: 'SVG export copied to clipboard.',
      unavailable: 'No match nearby',
      menu_title: 'Copy options',
      feedback_helper: 'Toast feedback mirrors the floating status pill.',
      no_feedback: 'Waiting for a clipboard action.',
      dismiss: 'Dismiss',
      options: {
        darker_aaa: 'Darker AAA (4.5:1)',
        darker_aa: 'Darker AA (3:1)',
        color: 'Color',
        lighter_aa: 'Lighter AA (3:1)',
        lighter_aaa: 'Lighter AAA (4.5:1)',
      },
    },
  },
  validation: {

...
- Replace the prototype’s global `StateClass` and ad-hoc URL/DOM wiring with modular stores that own serialization, debounce, and sharing concerns so UI files stay declarative.【F:temp/src/js/index.js†L36-L76】【F:temp/src/js/index.js†L315-L431】
...
- Stores abstract URL sync and import/export without manipulating the DOM, preventing the cross-cutting side effects present in the legacy script.
